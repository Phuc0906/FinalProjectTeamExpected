...
public class EntertainmentControllerPage4 extends EntertainmentBaseController {
    ...
    public void setImgList() {
        new SupportedMethod().setImgList(imgList, 30, this.newsList);
    ...
    public void setTitle() {
        new SupportedMethod().setTitleList(titleList, 30, this.newsList);
    }

    @FXML
    ArrayList<Label> descriptionList;
    public void setDescription() {
        new SupportedMethod().setDescriptionList(descriptionList, 30, this.newsList);
    }
}
